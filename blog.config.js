...
const BLOG = {
  AUTHOR: 'Weilev', // 作者
  BIO: '一个普通的干饭人🍚', // 作者简介
  LINK: 'https://weilevv.com', // 网站地址
  KEYWORDS: 'Notion, 博客, Weilev', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  ...
  COMMENT_GITALK_OWNER: process.env.NEXT_PUBLIC_COMMENT_GITALK_OWNER || 'Weilev', // 你的用户名 e.g tangly1024
  COMMENT_GITALK_ADMIN: process.env.NEXT_PUBLIC_COMMENT_GITALK_ADMIN || 'Weilev', // 管理员用户名、一般是自己 e.g 'tangly1024'
  ...
  AVATAR: '/avatar.jpg', // 作者头像，被notion中的ICON覆盖。如果没有ICON则取public目录下的avatar.png
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'Weilev BLOG', // 站点标题 ，被notion中的页面标题覆盖
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '这是一个由Weilev生成的站点', // 站点描述，被notion中的页面描述覆盖
